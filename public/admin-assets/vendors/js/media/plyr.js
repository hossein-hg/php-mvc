typeof navigator === "object" && (function (global, factory) {
  ...
  var defaults$1 = {
    ...
    // RegisterController for an account here: http://vi.ai/publisher-video-monetization/?aid=plyrio
    ads: {
      enabled: false,
      publisherId: '',
      tagUrl: ''
  ...
  function () {
    function Fullscreen(player) {
      ...
      this.forceFallback = player.config.fullscreen.fallback === 'force'; // RegisterController event listeners
  ...
  function () {
    ...
    function Ads(player) {
      ...
      this.managerPromise = new Promise(function (resolve, reject) {
        ...
        _this.on('loaded', resolve); // AdsController failed
    ...
    _createClass(Ads, [{
      ...
      value: function onAdError(event) {
        this.cancel();
        this.player.debug.warn('AdsController error', event);
      }
      /**
