...
class RegisterController
{
    ...
    public function register()
    {
        ...
        $inputs['avatar'] = ImageUpload::UploadAndFitImage($file,$path,$name,100,100);
        ...
        <p>کاربر گرامی ثبت نام شما با موفقیت صورت گرفت . برای فعالسازی حساب کاربری خود روی لینک زیر کلیک کنید</p>
