...
@section('content')
            ...
            <div class="container">
                <div class="row no-gutters slider-text align-items-md-end align-items-center justify-content-end">
                    <div class="col-md-6 text p-4 ftco-animate" style="direction: rtl;">
                        ...
                        <a href="<?= url($slide->url) ?>" class="btn-custom p-3 px-4 bg-primary">مشاهده جزئیات<span class="icon-plus mr-1"></span></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 search-wrap">
                    ...
                    <form action="<?= route('search') ?>" class="search-property">
                        <div class="row">
                            <div class="col-md align-items-end">
                                <div class="form-group">
                                    ...
                                    <div class="form-field">
                                        ...
                                        <input name="search" type="text" class="form-control text-right" placeholder="عنوان">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="properties-slider owl-carousel ftco-animate">
                        ...
                        <div class="item">
                            <div class="properties">
                                <a href="<?= route('ads',[$newestAd->id]) ?>" class="img d-flex justify-content-center align-items-center" style="background-image: url('<?= asset($newestAd->image) ?>');">
                                    <div class="icon d-flex justify-content-center align-items-center">
                                        <span class="icon-search2"></span>
                                    </div>
                                </a>
                                <div class="text p-3">
                                    <span class="status <?= $newestAd->sellStatus() == 'خرید' ? 'sale' : 'rent'  ?>"><?= $newestAd->sellStatus() ?></span>
                                    <div class="d-flex">
                                        <div class="one">
                                            <h3><a href="<?= route('ads',[$newestAd->id]) ?>"><?= $newestAd->address ?></a></h3>
                                            <p><?= $newestAd->type() ?></p>
                                        </div>
                                        <div class="two">
                                            <span class="price"><?= $newestAd->amount ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-sm col-md-6 col-lg ftco-animate">
                    <div class="properties">
                        ...
                        <div class="text p-3">
                            ...
                            <div class="d-flex">
                                <div class="one">
                                    <h3><a href="<?= route('ads',[$bestAd->id]) ?>"><?= $newestAd->address ?></a></h3>
                                    <p><?= $bestAd->type() ?></p>
                                </div>
                                <div class="two">
    ...
    <section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url('<?= asset("images-app/bg_1.jpg") ?>');">
        <div class="container">
