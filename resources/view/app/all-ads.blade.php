    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
                <p class="breadcrumbs"><span class="mr-2"><a href="<?= route('home') ?>">خانه</a></span> <span>آگهی ها</span></p>
        ...
        <div class="row">
            ...
            <div class="col-md-4 ftco-animate">
                <div class="properties">
                    <a href="<?= route('ads', [$advertise->id]) ?>" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url('<?= asset($advertise->image) ?>');">
                    ...
                    <div class="text p-3">
                        ...
                        <div class="d-flex">
                            <div class="one">
                                <h3><a href="<?= route('ads', [$advertise->id]) ?>"><?= $advertise->title ?></a></h3>
                                <p><?= $advertise->type() ?></p>
                            </div>
                            <div class="two">
